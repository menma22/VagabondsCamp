...
3. **重要な情報共有**：新しい知識、問題点、課題、参考情報（TODOと重複しないこと）
...
{transcript}`,
    ...
    en: {
        ...
        recordingGuide: {
            title: 'How to Record System Audio',
            description: 'To record audio from Zoom, Teams, etc., please follow these steps:',
            step1Title: 'Select "Entire Screen"',
            step1Desc: 'Choose the "Entire Screen" tab at the top',
            step2Title: 'Share Audio',
            step2Desc: 'Make sure to check "Share system audio" at the bottom left',
            step3Title: 'Start Sharing',
            step3Desc: 'Click the blue "Share" button',
            note: 'Note: This step is required due to browser security. If unchecked, remote audio will not be recorded.',
            start: 'Open Settings',
        },
        errors: {
